...
sys.path.append('/home/server1080/Documents/lt/HECKTOR/hecktor/src/')
sys.path.append('/home/server1080/Documents/lt/HECKTOR/hecktor/src/data/')
import dataset
import transforms
import utils
import models
...
def main(args):
    ...
    # model:
    model = models.ResSimAM_Unet(in_channels, n_cls, n_filters)
